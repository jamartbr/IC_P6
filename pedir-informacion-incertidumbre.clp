...
(defrule preguntar-dificultad
  ...
  =>
  (printout t "¿Qué dificultad prefieres? (muy_baja, baja, media, alta): " crlf)
  (bind ?d (read))
...
(defrule preguntar-duracion
  ...
  =>
  (printout t "¿Qué duración prefieres? (por ejemplo: 30m, 45m): " crlf)
  (bind ?t (read))
...
(defrule preguntar-personas
  ...
  =>
  (printout t "¿Para cuántas personas vas a cocinar?: " crlf)
  (bind ?n (read))
